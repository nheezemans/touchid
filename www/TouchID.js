...
TouchID.prototype.verifyFingerprint = function (message, fingerPrintOnly, passcodeLabel, successCallback, errorCallback) {
    cordova.exec(successCallback, errorCallback, "TouchID", "verifyFingerprint", [message, fingerPrintOnly, passcodeLabel]);
};
